...
const socials = [
  {
    ...
    bgHover: "hover:bg-[#25D366] hover:text-white hover:shadow-lg hover:shadow-[#25D366]/30",
  },
  {
    href: "https://instagram.com/trivokenya",
    label: "Instagram",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
    ...
    bgHover: "hover:bg-gradient-to-br hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#FCAF45] hover:text-white hover:shadow-lg hover:shadow-[#833AB4]/30",
  },
  {
    href: "https://tiktok.com/@trivokenya",
    label: "TikTok",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
    ...
    bgHover: "hover:bg-[#000000] hover:text-white hover:shadow-lg hover:shadow-[#000]/30",
  },
  {
    href: "https://x.com/trivokenya",
    label: "X",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
    ...
    bgHover: "hover:bg-[#000000] hover:text-white hover:shadow-lg hover:shadow-[#000]/30 dark:hover:bg-white dark:hover:text-black",
  },
  {
    href: "https://youtube.com/@trivokenya",
    label: "YouTube",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
    ...
    bgHover: "hover:bg-[#FF0000] hover:text-white hover:shadow-lg hover:shadow-[#FF0000]/30",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
            ...
            <div className="flex gap-2 pt-2 flex-wrap">
              {socials.map((s) => (
                <a
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-xl bg-surface/50 border border-subtle/20 text-muted-foreground transition-all duration-300 ${s.bgHover} hover:scale-110 active:scale-95`}
                  aria-label={s.label}
                >
                  {s.icon}
                </a>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-muted-foreground">
              <li><Link href="/how-to-order" className="hover:text-accent transition-colors">How to Order</Link></li>
              <li><Link href="/delivery" className="hover:text-accent transition-colors">Delivery Information</Link></li>
              <li><Link href="/returns" className="hover:text-accent transition-colors">Returns & Guarantee</Link></li>
              <li><Link href="/faq" className="hover:text-accent transition-colors">Frequently Asked Questions</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-muted-foreground">
              <li><Link href="/about" className="hover:text-accent transition-colors">About Trivo Kenya</Link></li>
              <li>
